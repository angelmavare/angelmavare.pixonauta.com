<?php 
$pageName = "Notson acustica | Angel Mavare"; 
$projectName = "Notson acustica";
?>
...
<div class="whatpage" id="project"></div>
    ...
    <div class="container main-container">
        <div class="col-md-12">
            <img src="assets/img/portfolio/nacustica/na-fig.jpg" alt="cover" class="img-responsive" />
            <div class="h-30"></div>
        </div>

        <div class="col-md-12">
            <h3 class="text-uppercase"><?php echo $projectName; ?></h3>
            <h5>Website for Notson Acustica</h5>
            <div class="h-30"></div>
        </div>
        ...
        <div class="col-md-9">
            ...
            <img src="assets/img/portfolio/nacustica/notsonacustica-home.jpg" alt="home" title=" home" class="img-responsive" style="margin-top:30px;" />
        ...
        <div class="col-md-3">
            <ul class="cat-ul">
                ...
                <li><i class="fa-solid fa-calendar-days text-center"></i> <strong>Date:</strong> Aug 2019</li>
