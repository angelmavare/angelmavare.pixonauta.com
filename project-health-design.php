<?php 
$pageName = "Health & Design | Angel Mavare"; 
$projectName = "Health & Design";
?>
...
<div class="whatpage" id="project"></div>
    ...
    <div class="container main-container">
        ...
        <div class="col-md-12">
            ...
            <h5>Web design for Health + Design</h5>
            <div class="h-30"></div>
        </div>

        <div class="col-md-9">
            <p>My responsibility was the web design adapting the identity of the brand. Work done for Accon software and client</p>
        ...
        <div class="col-md-3">
            <ul class="cat-ul">
                ...
                <li><i class="fa-solid fa-calendar-days text-center"></i> <strong>Date:</strong> March 2020</li>
                ...
                <li><i class="fa-solid fa-tag text-center"></i> <strong>Tags:</strong>  <span class="badge badge-primary">web-design</span><span class="badge badge-primary">website</span> </li>
